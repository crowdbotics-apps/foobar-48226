"""
Django settings for foobar_48226 project.
...
ROOT_URLCONF = 'foobar_48226.urls'
...
WSGI_APPLICATION = 'foobar_48226.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "foobar_48226 API",
    "DESCRIPTION": "API documentation for foobar_48226 App",
    "VERSION": "v1",
}
